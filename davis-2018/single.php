...
<?php if(!get_post_meta($id, "qode_show-page-title", true)) { ?>
			<div class="title animate <?php if($responsive_title_image == 'no' && $title_image != "" && $fixed_title_image == "yes"){ echo 'has_fixed_background '; } if($responsive_title_image == 'no' && $title_image != "" && $fixed_title_image == "no"){ echo 'has_background'; } if($responsive_title_image == 'yes'){ echo 'with_image'; } ?>" <?php if($responsive_title_image == 'no' && $title_image != ""){ echo 'style="background-image:url('.$title_image.'); height:'.$title_height.'px;"'; }?>>
				...
				<?php if(!get_post_meta($id, "qode_show-page-title-text", true)) { ?>
					...
					<?php } ?>
					<span class="blogTitle">Detroit Personal Injury Blog</span>
					<span class="pageTitle"><h1><?php the_title(); ?></h1></span>
					<span class="dialdavis"><span class="gold">Get Help Now.</span></span><br>
                    <a class="hero-cta" href="tel:313-462-7979">(888) Dial Davis</a>
					<?php if($title_in_grid){ ?>
						</div>
						...
						<div class="blog_single_holder">	
							<article>
								...
								<div class="blog_title_holder">
									 ...
									 <?php } ?>
									 <span><?php the_time('F jS, Y'); ?><!-- IN  <span class="category"><?php the_category(', '); ?></span>--></span>
								</div>
...
<?php if(get_post_meta(get_the_ID(), "qode_hide-featured-image", true) != "yes") {
								...
								<div class="blog_single_text_holder">
									<div class="text">
										<p><strong>Written by Maurice Davis</strong></p>
										<?php the_content(); ?>
									</div>
									<div class="info">
										<span class="left">
