		...
		<div class="container">
			<div class="columns">
				<div class="column-50">
					...
					<a href="tel:<?php the_field('header_cta_phone'); ?>" title="Call Today" class="button"><?php the_field('header_cta_phone'); ?></a>
				</div>
			</div>
		<div>
	</section>
		...
		<div class="container skinny">
			<div class="columns">
				<div class="column-50 first">
					...
					<a href="tel:<?php the_field('footer_cta_phone'); ?>" title="Call Today" class="button"><?php the_field('footer_cta_phone'); ?></a>
				</div>
				<div class="column-50">
	...
	<section id="page-footer" style="background-color:<?php echo $pageFooterBG; ?>">
		<div class="container">
			<div class="columns">
				<div class="column-50 first">
				<div id="head-logo">
                    <img src="/wp-content/uploads/2018/10/header-logo.png" class="custom-logo" alt="Davis Injury Lawyer" style="max-width:300px;">
				</div>
				</div>
				<div class="column-50">
